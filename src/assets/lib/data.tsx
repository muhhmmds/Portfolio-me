...
export const headerIntroData = {
  title: {
    ar: "مرحباً معكم مُحمد صابر",
    en: "Hi, I'm Muhammad Saber",
  },
  subtitle: "Front-End Developer",
  description: {
    ar: "أنا محمد ، مطور واجهات أمامية مصري أصيل من قلب القاهرة النابضة بالحياة. بعد أكثر من سنة من الشغف والتفاني في تصميم مواقع ويب وتطبيقات تفاعلية، أتقنت فن تحويل الأفكار إلى واقع ملموس باستخدام HTML، CSS، SASS، Bootstrap، JavaScript، ES6، وبراعة لا تضاهى في React.js وNext.js.",
    en: "I'm Muhammad, a frontend developer with the goal of advancing my career and participating in inspiring projects. Here I present my work and my passion for web development. Let's shape digital solutions together and shape the future!",
  },
  buttons: [
    {
      name: "Contact",
...
export const liveTickerData = {
  content: {
    de: "المزيد من المشاريع على جيت هاب",
...
export const sideBarRightMail = {
  link: "mailto:devmohamedsaber@gmail.com",
  text: "devmohamedsaber@gmail.com@com",
} as const;

export const sideBarLeftSocials = [
  {
    link: "https://www.linkedin.com/in/mhmmddsaber/",
    icon: FiLinkedin,
    altimgname: "linkedin",
  },
  {
    link: "https://github.com/muhhmmds",
    icon: FiGithub,
    altimgname: "github",
  },
  {
